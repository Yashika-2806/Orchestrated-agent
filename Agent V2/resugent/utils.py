...
1. Structural Hygiene: Page count compliance (prefers 1 page), and presence of core section headers.
...
def compute_score(data: ResumeData, config_overrides: dict = None) -> dict:
    ...
    S_hygiene = max(0, 100 - pen_page * max(0, P - 1) - pen_link * L_missing - pen_sec * X_missing)
